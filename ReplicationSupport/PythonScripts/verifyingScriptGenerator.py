...
def main():
    ...
    createOutputScript = "python3 tempcreateOutputFromMutation.py "+totalMutation+" /src/main/java/org/apache/commons/math3"+os.path.sep+packageName+" "+sourceFileName+" "+originalVersion+mutationAnalysisLog
    ...
    DestinationToSave = saveDestination+os.path.sep+packageName+os.path.sep+sourceFileName+os.path.sep #saveDestination is folderPath needs to be set
    ...
    moveFileToNewOutputDir = "mv ../output/04-*/ ../output/output/" # change everyday
