...
def main():
    ...
    if packageName !="x":
        createOutputScript = "python3 tempcreateOutputFromMutation.py "+totalMutation+" /src/main/java/org/apache/commons/cli"+os.path.sep+packageName+" "+sourceFileName+" "+originalVersion+mutationAnalysisLog
    else:
        createOutputScript = "python3 tempcreateOutputFromMutation.py "+totalMutation+" /src/main/java/org/apache/commons/cli"+" "+sourceFileName+" "+originalVersion+mutationAnalysisLog
    ...
    moveFileToNewOutputDir = "mv ../output/13-*/ ../output/output/" # change everyday
