...
def main():
    ...
    createOutputScript = "python3 createOutputFromMutation.py "+totalMutation+" /src/main/java/org/apache/commons/math3/analysis"+os.path.sep+packageName+" "+sourceFileName+" "+originalVersion+mutationAnalysisLog
    ...
    moveFileToNewOutputDir = "mv ../output/01-*/ ../output/output/" # change everyday
    ...
    relocateFinals = "mv ../finalResult/finalResult-"+sourceFileName+" "+DestinationToSave+" | mv ../finalResult/finalResult-others/ "+DestinationToSave
