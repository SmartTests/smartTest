...
'''
Need to change variables 'version' and 'fileName' for every java class and run createTempMapping.py before this file. Compares if the output from statement testCoverage
