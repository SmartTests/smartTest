...
public class LegendreHighPrecisionRuleFactoryTestIT extends GaussianQuadratureAbstractTestIT {
     ...
     */
    public LegendreHighPrecisionRuleFactoryTestIT(int numberOfPoints,
                                               int maxDegree,
                                               double eps,
                                               double numUlps) {
